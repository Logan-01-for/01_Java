...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		//변수 선언
		int num;
		//stack 영역에 int 자료형을 저장할 수있는 공간 4byte를 할당하고
		// 그공간에 num 이라는 이름을 부여.
		
		//변수 대입
		num = 10;
		// 생선된 num이라는 변수 공간에 10이라는 정수 값 대입
		...
		// ** 해당 변수는 참조형으로 주소값만을 저장 할수 있다 **
		
		//배열 할당
		arr = new int[3];// int 주소값만 저장 가능함 = 같은 자료형만 저장 가능
		// new : "new 연산자" 라고 하며
	...
	public void ex3() {
		...
		// height에 heap영역에 새로 생성된 double 5칸 짜리 배열의 주소를 대입
	...
	public void ex4() {
		...
		// 배열 선언 및 할당
		// 할당 할 배열의 크기는 입력받은 인원수 크기 만큼 (input)
	...
	public void ex6() {
		...
		//-> ! (Not 연산자 : 부정 논리 연산자) 붙여줌으로써 true로 변겨ㅓㅇ하여
		//{} 안에 있는 코드를 수행하게끔 함.
	...
	public void ex8() {
		...
		System.out.println(str.toString());// 위줄과 같음
		...
		// 주소값(객체의 해시 코드)을 확인하고 싶다면 아래처럼 사용...
		System.out.println(System.identityHashCode(str));
		
		String[] stArr= {"사과","바나나", "딸기"};
		// 메모리 구조가 어떻게 생겼을까?
	...
	public void ex9() {
		...
		// 2. 문자 하나를 입력받아 일치하는 문자 char 배열에 몇개 존재하는지 확인
		...
		for(int i =0; i< arr.length; i++) {
			...
			System.out.println(Arrays.toString(arr));
			//  * 문자열 입력 : hello[h,e,l,l,o]
			
			//2. 문자하나를 입력받아 일치하는 문자가 char 배열에 몇개 존재하는지 확인
			System.out.println("검색할 문자 입력 : ");
			char ch = sc.next().charAt(0);
			// sc.next()-> String형
			// String.chatAt(0) -> String 0번째 인덱스 문자 하나를 추출해서 char 형태로 반환
			// "h" -> 'h'
