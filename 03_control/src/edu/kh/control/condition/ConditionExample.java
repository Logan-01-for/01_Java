...
public class ConditionExample { // 기능 제공용 클래스
	...
	public void ex4() {
		// 달 (month)을 입력받아 해당 달에 맞는 계적 출력
		//1,2,12 겨울 (-15도 이햐 : "한파경보" / -12도 이햐 : "한파 주의보")
		//3~5 봄
		//6~8 여름 (35도 이상 : "폭엽 경보" / 33도 이상 : "폭염 주의보")
		//9~11 가을
		...
		String season; // 아래 조건문 수행 결과 저장할 변수 선언
...
public void ex5() {
	...
	public void ex6() {
		...
		String result; // 결과 값 담을 변수 선언
		
		if(input < 0|| input > 100) { //범위에서 벗어난 조건 부터 처리
			result = "잘못 입력하셨습니다";
...
// 탑승 가능!!!
		...
		if(age < 0 || age > 100) { //범위에서 벗어난 조건 부터 처리
		...
		} else { // 키를 0~ 250 정상 범주 입력한 경우 
			result = "키는 적절하나, 나이가 적절치 않음";
		
			
		} if (age >= 12 && height < 140.0) {// 나이 X, 키 X
			result = "나이와 키 모두 적절치 않음";
		
		} else {// 나이 0, 키 0( 그 외 조건 생각하기 : 변수를 선언만 했을 때)
			result ="탑승 가능!!";
		}
 	...
 	public void ex9() {
 		...
 		default : System.err.println("잘못된 입력이다");
