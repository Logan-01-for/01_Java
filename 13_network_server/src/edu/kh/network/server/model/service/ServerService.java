...
public class ServerService {
	// TCP Socket 프로그래밍
		...
		public void serverStart() {
			// 1)서버의 포트번호 정함
			int port = 8500;
			// 포트는 0 ~ 66535 사이을 지정 가능
			// 단, 1023번 이하는 이미 사용중인경우가 많으니 피하는게 좋음
			...
			// getHostAdress() : InetAddress 객체에서 IP 주소를 문자열 형실으로 반환.
