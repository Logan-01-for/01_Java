...
public class StudentService {
	...
	// 다형성 중 업캐스팅 적용!
	// 부모타입 (List) 참조변수 (studentList) = 자식 객체 (ArrayList) 주소
	...
	public StudentService() {
		...
		studentList.add(new Student("오미나", 27, "충북청주시", 'F',90));
	...
	public void ex() { // List 테스트용 예제
		...
		// 매개변수 타입이 Object == 모든 객체 매개변수로 전달 할 수있음
...
=======
				...
				case 7: sortByAge(); break;
				case 8: sortByName1(); break;
>>>>>>> 3344703e876b91ece7ff07820611d11a6c0e5fa4
				...
				// menuNum이 초기 값인 0을 가지고 있어 반복문이 종료되는데,
				// 이를 방지하기 위해서 임의 값 -1 대입
			}
	...
	// studentList가 비어있는지 확인
		...
		*/
		...
		int index = 0; // 1번 : 홍길동 객체 .... 앞에 번호
		for(Student std : studentList) {
			System.out.println((index++) + "번 : "); // index++ 0 번부터 , ++index 1번부터
	 ...
	 *  입력된 숫자가 0보다 작은지 검사,
	 *  작다면 "음수는 입력할 숭 없습니다" 반환
	 *  - studentList 범위 내 인덱스번호인지 검사, 
	 *  초과 했다면 "범위를 넘어선 값을 입력할 수 없습니다" 반환
	 *  
	 *  - 수정할 때 
...
=======
				 ...
				 * Student
				 * 
				 * - 일치하느 ㄴ경우 Student 객체 출력
				 * - 일치하는게 없다명 "검색 결과가 없습니다" 출력
				 * 
				 * @return
				 */	
			public void searchName1() {
					
				System.out.print("=====학생 검색(이름 완전 일치)=======");
...
>>>>>>> 3344703e876b91ece7ff07820611d11a6c0e5fa4
		 ...
		 * 
		 * -포함되는 학생 객체를 찾은 경우 Student 객체 출려
		 * - 없다면 "검색 결과가 없습니다" 출력
		 * 
		 */
		public void searchName2() {
			...
			for(Student std : studentList) {
				// 순서 유의!
				// boolean String.contains(문자열) : String 문자열이 포함되어있으면 true/ false
				if(std.getName().contains(input)) { // std.getName()에 input이 포함 되어있느냐?
					System.out.println(std);
		 ...
		 * List를 정리하는 방법
		 * 
		 * 방법 1: Comparable 인터페이스 상속 받아 comparaTo() 에서드 재정의
		 ...
		 * 즉시 사용(한 번만 사용할 Comparator 등을 정의 할때 유용함)
