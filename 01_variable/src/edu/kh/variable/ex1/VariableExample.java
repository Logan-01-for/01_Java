...
public class VariableExample {
	...
	// 변수 선언 : 메모리의 (RAM)에 값을 저장할 공간을 할당하는 것.
	// 변수 값 대입 : 변수에 값을 집어 넣는 것.
		...
		booleanData = true; // booleanData 변수에 true 논리값 집어 넣기 (대입)
	...
	// 자료형 변수명 = 대입연산자 값= 리터럴;	
		...
		int int_Number; // 자바는 카멜표기법 사용
			...
			char helloWorldAppleBannaTomato;
