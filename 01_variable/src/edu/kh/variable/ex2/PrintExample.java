...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		// System.out,println() : 한 줄 출력 용 메서느 (출력 후 줄바꿈 수행)
		System.out.println("테스트1");
		System.out.println("테스트2");
		
		// System.put.print() : 단순 출력용 메서드 (출력 후 줄바꿈 X)
		...
		// 유니코드 이스케이프
		System.out.println("\u0041"); // unicord u
		// 유니코드 (16진수)
		// 65를 16진수로 표현
		// 65 나누기 15 몫 4 , 나머지 1
