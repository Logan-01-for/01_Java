...
public class ClsService /*extends Student*/{ //  
			...
			// ClsServive(자식) <- Student(부모)
	public void ex1() {
		// 클래스 접근제한자 확인하기
		Student std = new Student();
		// public class 인 Student는 import 가능(어디서든 접근 가능)
		...
		// * 상속 받으면 부모의 것도 마치 내것 처럼 사용 *
		// System.out.println( v1 );// 상속 받은것
		// System.out.println( v2 );//상속 받아서 가능
		// Student 클래스를 ClsService 가 상속 받았으므로
		// Student 의 protected 변수인 v2는 직접 접근 가능!
	...
	public void ex2() {
		...
		System.out.println( std1.schoolName );// 기운 글자 static 변수
		 ...
		 * 그리고, static 여역에 생성된 변수는 어디서든지 공유 가능(공유)
		 * 
		 * 
		 * 
		 * */
	...
	public void ex3() {
		...
		// 문제점 : u1이 참조하는 있는 User 객체와
		// u2 가 참조하고 있는 User 객체의 필드 값이 모두 동일함
		// 왜? 같은 기본 생성자로 User 객체를 생성 했기 때문에
	...
	public void ex4() {
		...
		User u3 = new User("user04", "pass03", 
				"김길동", 30, '남');
		// 매개변수 5개 짜리 생성자(전부 초기화)
