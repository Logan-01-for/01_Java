...
// {접근 제한자] [예약어] class 클래스명
	...
	// 클래스 변수( == static 변수) : 필드에 static 예약어가 작성된 벼수
	...
	int v3 = 30; // 아무것도 안쓰면 default = 같은 패키지내까지 가능
	...
	// 3. 메서드
	// getter만 만들어진 이유 : final 예약어가 붙은 TEMP!은 상수
	// 재대입 불가함 ( == setter 굳이 X )
	public int getTEMP1() {// 상수는 값을 변경 할수가 없음
		return TEMP1;
	}
	...
	public void ex() {
		...
		// 필드 접근 제한자 확인하기
		// v1~v4 까지 전부 Student 클래스 내부에서 생성된 변수 이기 때문에
