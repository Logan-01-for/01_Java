...
public class MemberService {
	...
	public void displayMenu() {
		...
		do {
			...
			case 4 : 
				...
				if(result == -1) {
					System.out.println("로그인 후 이용하람");
				}else if(result == 0) {
					System.out.println("회원 정보 실패 (비밀번호 불일치)");
				}else {
					// result == 1
	...
	// -> 조회하려면?
	//-> 로그인을 했는지 안했는지 확인
	// 1. 로그인 했으면? 현재 로그인한 사람의 정보를 저장하고있는 객체에서
	//  정보 얻어오기 (이름,아이디,나이)
